...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=1999,
    path=Path("./data/hpms/raw/1999PRD.xls"),
...
def extract_1999prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("E", "SOLANA_BEACH", 703),
        ("E", "VISTA", 704),
        ("D", "UNINCORPORATED", 706),
        ("D", "STATE_HIGHWAY", 707),
        ("D", "STATE_PARKS_AND_REC", 708),
        ("D", "US_BUREAU_OF_INDIAN_AFFAIRS", 709),
        ("D", "US_FOREST_SERVICE", 710),
        ("D", "US_MILITARY", 711),
        ("D", "US_NATIONAL_PARK_SERVICE", 712),
    ]
]
