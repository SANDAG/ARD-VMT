...
SOURCE = hpms.PublicRoadDataPDFSource(
    year=2022,
    pdf_path=Path("./data/hpms/raw/hpms2022_prd_final.pdf"),
    pdf_jurisdiction_page=98,
    pdf_mpo_page=146,
    extract_path=Path("./data/hpms/raw/2022 HPMS Extract.xlsx"),
...
def extract_2022prd_jurisdiction(
