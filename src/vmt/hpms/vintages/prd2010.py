...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=2010,
    path=Path("./data/hpms/raw/2010_PRD.xlsx"),
    jurisdiction_sheet_name="2010 PRD_Table 6",
    mpo_sheet_name="2010 PRD_Table 10",
    description="...",
)


def extract_2010prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("B", "US_DEPARTMENT_OF_DEFENSE", 727),
        ("B", "INDIAN_TRIBAL_NATION", 728),
        ("B", "US_NATIONAL_PARK_SERVICE", 729),
...
MPO_EXTRACTS = [
    ...
    for (col, key, number) in [
        ("B", "AMBAG", 7),
        ("B", "BCAG", 8),
        ("B", "FCOG", 9),  # COFCG IN 2010
        ("B", "KCOG", 10),  # KERNCOG IN 2010
        ("B", "KCAG", 11),  # KINGCAG in 2010
        ("B", "MCAG", 12),
        ("B", "MCTC", 13),  # MADCAG IN 2010
        ("B", "MTC", 14),
        ("B", "SACOG", 15),
        ("B", "SANDAG", 16),
        ("B", "SBCAG", 17),
        ("B", "SCAG", 18),
        ("B", "SRTA", 19),  # SCRTPA IN 2010
        ("B", "SJCOG", 20),
        ("B", "SLOCOG", 21),
        ("B", "STANCOG", 22),
        ("B", "TCAG", 23),
        ("B", "TRPA", 24),  # TMPO IN 2010
        ("B", "NONE", 26),
    ]
]
