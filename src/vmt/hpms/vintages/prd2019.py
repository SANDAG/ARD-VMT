...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=2019,
    path=Path("./data/hpms/raw/2019_PRD.xlsx"),
...
def extract_2019prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("B", "ENCINITAS", 1017),
        ("B", "ESCONDIDO", 1018),
        ("B", "IMPERIAL_BEACH", 1019),
        ("B", "LA_MESA", 1020),
        ("B", "LEMON_GROVE", 1021),
        ("B", "NATIONAL_CITY", 1022),
        ("B", "OCEANSIDE", 1023),
        ("B", "POWAY", 1024),
        ("B", "SAN_DIEGO", 1025),
        ("B", "SAN_MARCOS", 1026),
        ...
        ("B", "VISTA", 1029),
        #
        ("B", "US_BUREAU_OF_INDIAN_AFFAIRS", 1031),
        ("B", "OTHER_STATE_AGENCIES", 1032),
        ("B", "UNINCORPORATED", 1033),
        ("B", "STATE_HIGHWAY", 1034),
        ("B", "STATE_PARKS_AND_REC", 1035),
        ("B", "US_FISH_AND_WILDLIFE", 1036),
        ("B", "US_FOREST_SERVICE", 1037),
        ("B", "US_ARMY_AND_MARINE_CORPS", 1038),
    ]
]
