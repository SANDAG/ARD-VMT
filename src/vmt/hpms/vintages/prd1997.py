...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=1997,
    path=Path("./data/hpms/raw/1997PRD.xls"),
...
def extract_1997prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("E", "SOLANA_BEACH", 740),
        ("E", "VISTA", 741),
        ("D", "UNINCORPORATED", 743),
        ("D", "STATE_HIGHWAY", 744),
        ("D", "STATE_PARKS_AND_REC", 745),
        ("D", "US_BUREAU_OF_INDIAN_AFFAIRS", 746),
        ("D", "US_BUREAU_OF_LAND_MANAGEMENT", 747),
        ("D", "US_FOREST_SERVICE", 748),
        ("D", "US_NATIONAL_PARK_SERVICE", 750),
    ]
]
