...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=2020,
    path=Path("./data/hpms/raw/2020_PRD.xlsx"),
...
def extract_2020prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("B", "ENCINITAS", 1019),
        ("B", "ESCONDIDO", 1020),
        ("B", "IMPERIAL_BEACH", 1021),
        ("B", "LA_MESA", 1022),
        ("B", "LEMON_GROVE", 1023),
        ("B", "NATIONAL_CITY", 1024),
        ("B", "OCEANSIDE", 1025),
        ("B", "POWAY", 1026),
        ("B", "SAN_DIEGO", 1027),
        ("B", "SAN_MARCOS", 1028),
        ...
        ("B", "VISTA", 1031),
        #
        ("B", "US_BUREAU_OF_INDIAN_AFFAIRS", 1033),
        ("B", "OTHER_STATE_AGENCIES", 1034),
        ("B", "UNINCORPORATED", 1035),
        ("B", "STATE_HIGHWAY", 1036),
        ("B", "STATE_PARKS_AND_REC", 1037),
        ("B", "US_FISH_AND_WILDLIFE", 1038),
        ("B", "US_FOREST_SERVICE", 1039),
        ("B", "US_ARMY_AND_MARINE_CORPS", 1040),
    ]
]
