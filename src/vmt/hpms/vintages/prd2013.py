...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=2013,
    path=Path("./data/hpms/raw/2013_PRD.xlsx"),
    jurisdiction_sheet_name="2013 PRD_Table 6",
    mpo_sheet_name="2013 PRD_Table 9",
    description="...",
)


def extract_2013prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("B", "VISTA", 738),
        #
        ("B", "US_BUREAU_OF_INDIAN_AFFAIRS", 740),
        ("B", "INDIAN_TRIBAL_NATION", 741),
        ("B", "US_NATIONAL_PARK_SERVICE", 742),
        ("B", "UNINCORPORATED", 743),
        ("B", "SAN_DIEGO_UNIFIED_PORT_DISTRICT", 744),
        ("B", "STATE_HIGHWAY", 745),
        ("B", "STATE_PARKS_AND_REC", 746),
        ("B", "US_ARMY", 747),
        ("B", "US_MARINE_CORPS", 748),
        ("B", "US_NAVY", 749),
        ("B", "US_FISH_AND_WILDLIFE", 750),
        ("B", "US_FOREST_SERVICE", 751),
    ]
]
...
MPO_EXTRACTS = [
    ...
    for (col, key, number) in [
        ("A", "AMBAG", 7),
        ("A", "BCAG", 8),
        ("A", "FCOG", 9),  # COFCG IN 2013
        ("A", "KCOG", 10),  # KERNCOG IN 2013
        ("A", "KCAG", 11),  # KINGCAG in 2013
        ("A", "MCAG", 12),
        ("A", "MCTC", 13),  # MADCAG IN 2013
        ("A", "MTC", 14),
        ("A", "SACOG", 15),
        ("A", "SANDAG", 16),
        ("A", "SBCAG", 17),
        ("A", "SCAG", 18),
        ("A", "SRTA", 19),  # SCRTPA IN 2013
        ("A", "SJCOG", 20),
        ("A", "SLOCOG", 21),
        ("A", "STANCOG", 22),
        ("A", "TCAG", 23),
        ("A", "TRPA", 24),  # TMPO IN 2013
        ("A", "NONE", 26),
    ]
]
