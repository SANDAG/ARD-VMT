...
SOURCE = hpms.PublicRoadDataExcelSource(
    year=2016,
    path=Path("./data/hpms/raw/2016_PRD.xlsx"),
    jurisdiction_sheet_name="2016 PRD_Table 6",
    mpo_sheet_name="2016 PRD_Table 9",
    description="...",
)


def extract_2016prd_jurisdiction(
...
JURISDICTION_EXTRACTS = [
    ...
    for (col, key, number) in [
        ...
        ("B", "VISTA", 684),
        #
        ("B", "US_BUREAU_OF_INDIAN_AFFAIRS", 686),
        ("B", "OTHER_STATE_AGENCIES", 687),
        ("B", "STATE_HIGHWAY", 688),
        ("B", "STATE_PARKS_AND_REC", 689),
        ("B", "US_FISH_AND_WILDLIFE", 690),
        ("B", "US_FOREST_SERVICE", 691),
        ("B", "US_ARMY_AND_MARINE_CORPS", 692),
        ("B", "UNINCORPORATED", 693),
    ]
]
